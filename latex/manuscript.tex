...
% Line numbering for review only
\linenumbers
...
% with DeepLabv3 performing best overall, though SAM achieved top accuracy with 
% fewer training images. The analysis was validated using two documented 
% seeps in the Arctic, where our method could potentially identify additional, 
% undiscovered seepage sites. Overall, our findings highlight the potential of 
% transfer learning. This approach remains underutilized in remote sensing, 
% yet it is promising for addressing data scarcity, with practical applications 
% such as monitoring natural seepage in remote marine environments. 
