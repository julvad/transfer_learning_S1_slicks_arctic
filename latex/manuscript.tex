...
help reduce false detections, despite a somewhat undervalued Dice score (middle, Fig. \ref{figure3}c). The last row (Fig. \ref{figure3}a) examplifies one of the most challenging cases for SAR slick mapping. 
