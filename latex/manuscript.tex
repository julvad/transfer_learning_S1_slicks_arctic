...
\thanks{Corresponding author email address: julien.vadnais@uib.no. All data and code used in this study is accesible on the GitHub repository $https:/github.com/julvad/temp_repo_a0$}
...
use by adding trainable classification layers to SAM's mask encoder \cite{esrideveloperFinetuneSegmentAnything2025}. Data augmentation was generated in the form of a 30° rotation, brightness and contrast shifts, 
